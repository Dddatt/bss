...
box(10,-0.01,-10.3,5,25,5,false,[1.1,0.9,0.1],true,false);
...
cylinder(3,1004,1005,1.25,1,6,10,10,0,1,0.001,-20,30);
cylinder(3,1004,1005.1,1,1,6,1.3,1.3,1.3,1,0.001,-20,30);
cylinder(0,1007,1005,1.25,1,6,10,10,0,1,15,0,30);
cylinder(0,1007,1005.1,1,1,6,1.3,1.3,1.3,1,15,0,30);
...
function dispenser(x,y,z,a,r1,g1,b1,r2,g2,b2,r3,g3,b3,r4,g4,b4,a4,rj){
    ...
    cylinder(x,y+0.5+2+0.25,z,1.25,0.5,15,...(rj?[0.9,0.8,0]:[0.7,0.7,0.7]),0.75,-90,180+a,0);
