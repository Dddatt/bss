...
box(52,10,-19,10,7,2.95,[0,-54,0],INFO.allowed_35,typeof INFO.allowed_35==='string',false);
...
box(35.5,4,13.5+8.75,1.2,6,5,[90,0,0],INFO.allowed_redHQ,typeof INFO.allowed_redHQ==='string',false);
...
box(-31+55,34-20,68.76-5.25,8,9,1.8,[0,0,90],INFO.allowed_15,typeof INFO.allowed_15==='string',false);
...
box(-31+20,34-30,68.76-25.5,8,9,1.8,[0,0,90],INFO.allowed_5,typeof INFO.allowed_5==='string',false);
...
box(-91,22,113,4,5,1.22,[0,90,0],INFO.allowed_dapper,typeof INFO.allowed_dapper==='string',false);
...
box(-31-27.5,34-20,68.76-5.25,8,9,1.8,[0,0,90],INFO.allowed_10,typeof INFO.allowed_10==='string',false);
...
box(-31,34,68.76,8,9,1.8,[0,0,90],INFO.allowed_25,typeof INFO.allowed_25==='string',false);
...
box(-61,5.9-3.5,26.5+8.75+2.4,1.5,2.8,1.5,[-45,0,0],[0.1,0,0.9],true,false);
box(-61,4-3.5,26.5+8.75,1.2,6,5,[90,0,0],INFO.allowed_blueHQ,typeof INFO.allowed_blueHQ==='string',false);
...
box(52-68,10-3,-19-16,10,7,2.95,[0,30,0],INFO.allowed_20,typeof INFO.allowed_20==='string',false);
...
box(49.25+2,14,68+2,2,5,5,[0,45,0],INFO.allowed_sprinkler,typeof INFO.allowed_sprinkler==='string',false);
