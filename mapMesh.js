...
box(8.5,0,-24.5,28,25,19,false,WALL,true,false);
box(8.5,7,-26,28,21,10,false,WALL,true,false);
box(8.5,12,-29.2,28,21,4.5,false,WALL,false,false);
box(8.5,22.775,-41.4,28,7,20,false,WALL,true,false);
box(8.5,17.85,-24.5,28,4,21.5,[40,0,0],WALL,true,false);
...
box(41.5-3,10+Math.cos(25*0.0174533)*2,13+Math.sin(25*0.0174533)*2,2,0.25,0.25,[0,0,0],[0.4,0.2,0.1],false,false);
box(41.5-3,10+Math.cos(25*0.0174533),13+Math.sin(25*0.0174533),2,0.25,0.25,[0,0,0],[0.4,0.2,0.1],false,false);
box(41.5-3,10,13,2,0.25,0.25,[0,0,0],[0.4,0.2,0.1],false,false);
box(41.5-3,10+Math.cos(25*0.0174533)*-1,13+Math.sin(25*0.0174533)*-1,2,0.25,0.25,[0,0,0],[0.4,0.2,0.1],false,false);
box(41.5-3,10+Math.cos(25*0.0174533)*-2,13+Math.sin(25*0.0174533)*-2,2,0.25,0.25,[0,0,0],[0.4,0.2,0.1],false,false);
...
box(28.55,-5.175,49.5-7.44-3,3,20,20,[55,0,0],[1*0.4,0.7*0.4,0.3*0.4],false);
box(28.55-0.1,-5.175,49.5-7.44-3,3+0.2,20,20,[55,0,0],[1*0.4,0.7*0.4,0.3*0.4,0.3],true,false,false);
box(32.05+1.5-5,0,49.5+1.5-3,3,17.5,13,false,[1*0.4,0.7*0.4,0.3*0.4]);
box(23,7,42,2,7,12,[0,85,15],[0.55,0.55,0.55],true,true);
box(28.4,10,50,3,7,16,[-20,2,0],[0.5,0.5,0.5],true,true);
box(32.1-0.5+2,5,57.5,9+4,15,10,false,[0.4,0.4,0.4],true,true);
box(29.3,6,59.1,3,20,7,[0,0,6],[0.5,0.5,0.5],true,true);
...
box(-31+55,34-20,68.76-5.25,8,9,1.8,[0,0,90],[0,0.8,0,0.6],false,false);
...
box(-103,22.25,106,15,0.5,3,false,[0,0.1,0.6],true,false);
box(-103,22.25,121,15,0.5,3,false,[0,0.1,0.6],true,false);
box(-103,22.25+3,121,15,0.5,3,false,[0,0.1,0.6],true,false);
...
box(20,9.2,95+1,82.5,62,4+2,[0,0,-15],WALL,true,false);
box(-47.6,15.25,95+1,35,62,4+2,[0,0,15],WALL,true,false);
box(-10,13,95+1,15,62,4+2,false,WALL,true,false);
box(-38,13,95+1,15,62,4+2,false,WALL,true,false);
box(-25,45.25,95+1,27.5,9,4+2,false,WALL,true,false);

box(-12,23,95+1,15,42,4+2,false,WALL,true,false);
...
box(-28,13+8,-16.5,4,39.5,15,false,WALL,true,false);
box(-35.5,12.25+15+0.5+0.5,-2.75,4,55-30,22.5,[0,-45.6,0],WALL,true,false);
...
box(-28,13+4,-19.5,4,47.5,16,false,WALL,true,false);
box(-32.15,13+4,-38.55,4,47.5,25,[0,20,0],WALL,true,false);
box(-36.5,13+4,-56,4,47.5,25,false,WALL,true,false);
box(-18,13+4,-69,33,47.5,4,false,WALL,true,false);
box(8.5-13,22.775-8,-42.4-0.25,28-26,7+16,22.5,false,WALL,true,false);
box(-3.5,12.665,-66.875,4,47.5,30,[32,0,0],WALL,true,false);
...
box(52-68,10-3,-19-16,10,7,2.95,[0,30,0],[0,0.8,0,0.6],false,false);
...
box(-60,-3,-11,5,7,6,[0,0,0],[0.9*0.6,0.7*0.6,0.3*0.6],true,true);
...
box(49.25+2,14,68+2,2,5,5,[0,45,0],[0,0.8,0,0.6],false,false);
...
box(62.5,14.5,55.5+3,1,4,7,false,[0,0.8,0,0.6],false,false);
...
box(-79,9,15.5,7,9,6,false,[0.4,0.275,0.1],true,true);
...
box(-25,23,95,15,42,4,false,[0,0.8,0,0.6],false,false);
...
box(-50,14,86.5,3,0.75,13,false,[0.5,0.35,0],true,true);
box(-39,14,86.5,3,0.75,13,false,[0.5,0.35,0],true,true);
box((-39-50)*0.5,14,91.5,13,0.75,3,false,[0.5,0.35,0],true,true);
box(-50,19,86.5,3,0.75,13,false,[0.5,0.35,0],false,true);
box((-39-50)*0.5-2.5,19,91.5,8,0.75,3,false,[0.5,0.35,0],false,true);
box(-38,19,92.5,4,4,2,[0,45,0],[0.5,0.35,0],false,true);
...
box(-5.53,37,74,1,0.15,0.65,false,[0,10,0],true,false);
box(-5.53,37,74,1,0.65,0.15,false,[0,10,0],true,false);
