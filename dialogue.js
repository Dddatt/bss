...
window.dialogue_brownBear=function(player,items,NPCs){
    ...
    return function(diff){
        ...
        if(diff){
            ...
            if(diff===50) rew.push(['bearBeeEgg',1])
        ...
        return ["Welcome! Ready for one of my repeatable quests?","I'll give honey and rewards for every quest, but special prizes at certain milestones!","Obtain a Bear Bee egg at 50 quests!","Check your quest menu to see what you need.",
