window.dialogue_blackBear=function(player,items){
    ...
    return ["here",function(){player.addQuest('*very* specific quest requirements',[['tokensFromPlantersInTheSpiderField',5],['beeTypes',8],['hasteTokens',1],['redExtract',1],['goo',1],['flames',8],['bubbles',8],['fallingCoconuts',1],['fireAnt',1],['itemsUsingTheBlender',1],['timesUsingTheRedCannon',1],['tokensFromSprouts',10],['tokensFromPlanters',5],['hoursOfInvigoratingNectar',1]],'blackBear');},"a",function(){addReward([['honey',1000000]])},'bye']
